...
var DataService = /** @class */ (function () {
    function DataService(database, auth) {
    ...
    DataService.prototype.getAuthenticatedUserProfile = function () {
        ...
        return this.auth
            ...
            .mergeMap(function (authId) {
            return _this.database.object("profiles/" + authId).valueChanges();
        })
            .take(1);
    };
    DataService.prototype.setUserOnline = function (profile) {
        var ref = database().ref("online-users/" + profile.firstName);
        try {
