...
var ChatService = /** @class */ (function () {
    ...
    ChatService.prototype.getChannelChatRef = function (name) {
        return this.database.list("channels/" + name).valueChanges();
    };
    ChatService.prototype.sendChannelChatMessage = function (chatKey, message) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.database.list("channels/" + chatKey).push(message)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
